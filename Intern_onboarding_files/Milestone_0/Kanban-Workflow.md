...
Team members can see the status of all tasks at any time, making it clear who is working on what, where blockers exist, and how the project is progressing overall.
...
When tasks pile up or stall in a column, the board makes the bottleneck immediately visible, allowing the team to discuss and address it in real time rather than discovering the problem only at the end of a sprint.

## How can you improve your workflow using Kanban principles?

As a mobile app developer, my daily and weekly tasks go beyond just coding — they also include maintaining documentation, attending meetings, and other responsibilities.
To manage this, I would create a personal Kanban board, updating the Backlog weekly and maintaining task status on a daily basis.
I would also set a personal WIP limit of 1–2 cards in In Progress at a time, forcing myself to finish what I've started before picking up something new,
rather than having multiple tasks half-done at once.
